...
public class UsersControllerTest {
    ...
    private final Logger logger = LoggerFactory.getLogger(UsersControllerTest.class);
    ...
    public void testGetText() throws Exception {
        ...
        MvcResult result = this.mockMvc.perform(get("/users").contentType(MediaType.APPLICATION_JSON).content(data.toString()))
